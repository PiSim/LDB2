...
namespace LabDB2
{
    class Bootstrapper : UnityBootstrapper
    {
        ...
        protected override void ConfigureModuleCatalog()
        {
            ...
            ModuleCatalog.AddModule(
                new Prism.Modularity.ModuleInfo(MastersModuleType.Name, MastersModuleType.AssemblyQualifiedName));

            Type MethodsModuleType = typeof(Methods.MethodsModule);
            ModuleCatalog.AddModule(
                new Prism.Modularity.ModuleInfo(MethodsModuleType.Name, MethodsModuleType.AssemblyQualifiedName));

            Type ProjectsModuleType = typeof(Projects.ProjectsModule);
            ModuleCatalog.AddModule(
                new Prism.Modularity.ModuleInfo(ProjectsModuleType.Name, ProjectsModuleType.AssemblyQualifiedName));

            Type ReportsModuleType = typeof(Reports.ReportsModule);
            ModuleCatalog.AddModule(
                new Prism.Modularity.ModuleInfo(ReportsModuleType.Name, ReportsModuleType.AssemblyQualifiedName));

            Type SpecificationModuleType = typeof(Specifications.SpecificationsModule);
            ModuleCatalog.AddModule(
                new Prism.Modularity.ModuleInfo(SpecificationModuleType.Name, SpecificationModuleType.AssemblyQualifiedName));

            Type StandardModuleType = typeof(Standards.StandardsModule);
            ModuleCatalog.AddModule(
                new Prism.Modularity.ModuleInfo(StandardModuleType.Name, StandardModuleType.AssemblyQualifiedName));

            Type TaskModuleType = typeof(Tasks.TasksModule);
            ModuleCatalog.AddModule(
                new Prism.Modularity.ModuleInfo(TaskModuleType.Name, TaskModuleType.AssemblyQualifiedName));
        }
